...
@views.route('/temp_prof/<user_id>',methods=['GET', 'POST'])
@login_required
def temp_profile(user_id):
    # 个人资料页面
    accessingUser=User.query.get(user_id) # 根据请求url获得被访问用户id
    return render_template("temp_prof.html",user=current_user,accessingUser=accessingUser)